 ...
 *    RPM Version Compare
 * SYNOPSIS
 *    *rvc* *version-release-a* *version-release-b*
 * DESCRIPTION
 ...
 *      * -1: b is newer than a 
 * AUTHOR
 *    Luigi Bitonti, modified by Alejandro Liu Ly
 * SEE ALSO
 *    *rpm(8)*
 *--
 *
...
main(int argc, char **argv)
{
    ...
    if (argc != 3)
    {
      fprintf(stderr, "Usage: %s <RPM_versionA>-<RPM_releaseA> <RPM_versionB>-<RPM_releaseB>\n%s v%s\n", argv[0],argv[0],version);
      return 1;
    }
